...
<b>Command:<\b> /upload
<b>Limk<\b>: Magnet Link / Direct Link / Torrent File 
<b>Upload type<\b>: Media ( Default )
<b><\b>: <code>( Optional )</code>
