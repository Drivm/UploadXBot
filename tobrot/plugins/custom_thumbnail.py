...
async def save_thumb_nail(client, message):
    ...
    if message.reply_to_message is not None:
        ...
        await ismgs.edit(
            "Custom thumbnail **saved** for next uploads"
        )
    else:
        await ismgs.edit("Please, Reply with an image to save your custom thumbnail.</b>")
...
async def clear_thumb_nail(client, message):
    ...
    if os.path.exists(thumb_image_path):
        ...
        await ismgs.edit("Custom thumbnail deleted")
    else:
        await ismgs.edit("Custom thumbnail deleted")
