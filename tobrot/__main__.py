...
botcmds = [
        ...
        (f'setprefix','🔠 <Text> Save Custom Prefix for Uploads'),
        (f'{BotCommands.MediaInfoCommand}','ℹ️ [Reply] Get files media info'),
       #(f'settemplate','📋 <Text> Set IMDb Custom Template for Usage!!'),
        ...
        (f'{BotCommands.ToggleVidCommand}','🎞️ Switch to streamable upload '),
       ...
       #(f'{BotCommands.PytdlCommand}',' 🗒️ [Reply] YT-DL Playlists Links for Uploading...'),
        ...
        (f'{BotCommands.HelpCommand}','💻 Bot commands help module'),
